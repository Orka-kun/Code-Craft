...
const page = () => {
  return (
    <div>
    <div className="font-Nunito bg-gray-900 md:h-screen">
      <div className="grid md:grid-cols-2 items-center gap-8 h-full">
        <div className="max-md:order-1 p-4">
          <Image className="lg:max-w-[80%] h-full w-full object-contain block mx-auto" alt="login-image" src={loginImage} />
        </div>
        ...
        <div className="flex items-center md:p-8 p-6 bg-white md:rounded-tl-[55px] md:rounded-bl-[55px] h-full">
          <form className="max-w-lg w-full mx-auto">
            <div className="mb-12">
              ...
              <p className="text-gray-800 text-sm mt-4 ">Go back to <Link href="#home" className="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Home</Link></p>
            </div>
            ...
            <div className="mt-12">
              <button type="button" className="w-full py-3 px-6 text-sm font-semibold tracking-wider rounded-full text-white bg-gray-800 hover:bg-[#222] focus:outline-none">
                Sign in
              </button>
            </div>
